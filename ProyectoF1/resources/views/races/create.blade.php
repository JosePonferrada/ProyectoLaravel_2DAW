        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.races.store') }}" class="mt-6 space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="season" name="season" type="number" class="mt-1 block w-full" :value="old('season', $currentYear)" required min="1950" max="{{ date('Y') + 1 }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="laps" name="laps" type="number" class="mt-1 block w-full" :value="old('laps')" required min="1" />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="weather" name="weather" type="text" class="mt-1 block w-full" :value="old('weather')" />
